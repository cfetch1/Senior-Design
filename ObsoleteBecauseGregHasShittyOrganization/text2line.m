function text2line(h,ksi,z,T,size)
...
switch z==0
    case 1
        text(x(i), y(i), T,'HorizontalAlignment','center', 'BackgroundColor', 'w', 'rotation', a,'FontSize',size);
    case 0
        ez=[dy,-dx]/norm([dy,-dx]); % unit normal vector
        text(x(i)+z*ez(1), y(i)+z*ez(2), T, 'HorizontalAlignment','center', 'rotation', a,'FontSize',size);
end
