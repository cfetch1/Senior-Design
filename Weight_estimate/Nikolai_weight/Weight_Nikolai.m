function [W_airframe,Wcomp_nic] = Weight_Nikolai(MTOW, Wfuel,L_sm,S_v,bv,t_rv,VeqMax,fuse_width, fuse_diam, Ltot,S_h,lt,t_rh,bh,AR, sweep, S, lambda, t_c)
    ...
    Wcomp_nic(:,1)=["LG";"VT";"Fuse";"HT";"Struct";"Airframe Total"];
    Wcomp_nic(:,2)=[W_lg;W_ver_tail;W_fuse;W_h_tail;W_struct;W_airframe(end)];
end
