...
% w_v = (1.68*(MTOW^0.567)*(S_v^1.24)*(A_v^0.482)) / (15.6*(t_rv^0.747)*(cosd(sw_a)^0.882));
% I think its this actually: 
w_v = (1.68*(MTOW^0.567)*(S_v^1.24)*(A_v^0.482)) / (639.5*(t_rv^0.747)*(cosd(sw_a)^0.882));

% w_h = (3.184*(MTOW^0.887)*(S_h^0.101)*(A_h^0.138)) / (57.5*(t_rh^0.223));
% Also I think its this:
w_h = (3.184*(MTOW^0.887)*(S_h^0.101)*(A_h^0.138)) / (174.04*(t_rh^0.223));

% constants seemed off for denominator 
W_emp = w_h + w_v ;
